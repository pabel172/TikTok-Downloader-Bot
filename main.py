...
def help(client, message):
    kb = [[InlineKeyboardButton('Channel 🛡', url=https://t.me/naxsjupdate),InlineKeyboardButton('Repo 🔰', url="https://github.com/TerminalWarlord/TikTok-Downloader-Bot/")]]
    reply_markup = InlineKeyboardMarkup(kb)
